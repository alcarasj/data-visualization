...
def index():
	...
	return render_template('./index.html', gt_data=json.dumps(gt_data), results_data=json.dumps(results_data), gt_ccr=json.dumps(gt_ccr), results_ccr=json.dumps(results_ccr))
